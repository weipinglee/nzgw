                    ...
                    <div class="modal-dialog" style="width:738px; margin:50px auto">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mtk_k">
                                    <span style="float:left; font-size:16px; line-height:32px; padding-right:10px">姓名</span><div class="mtk_k2"> <input name="input2" type="text" size="35" value="请输入您的姓名" onfocus="this.value=&#39;&#39;" class="mtk_k3 js-name" style="outline: none;"></div></div>
                                <div class="mtk_k4">
                                    <span style="float:left; font-size:16px; line-height:32px; padding-right:10px">手机号码</span><div class="mtk_k2"> <input name="input2 " type="text" size="35" value="请输入您的手机号码" style="outline: none;" onfocus="this.value=&#39;&#39;" class="mtk_k3 js-mobile"></div></div>
                            </div>

                            <div class="modal-footer">
                                <div class="mtk5"> 目前已成功预约<span style="color:#F00; font-weight:bold"> 440</span>  位业主</div>
                                <button class="js-myModal" style=" border:none; background-color:#FFF"> <a href="villa.html#"><img src="{views:home/images/sjs.gif}" width="124" height="34"></a></button>
                            </div>
                        </div>
                    </div>
                </div>
